...
- Approve —Recipient views, downloads the decrypted file, and clicks Approve to confirm receipt
- Track —Sender sees full audit log —who opened it, when, and how many time
